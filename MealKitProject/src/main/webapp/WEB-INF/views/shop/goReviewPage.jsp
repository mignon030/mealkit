...
.nobuy { font-size:20px; color:#888; text-align:center; }
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tbody>
							<c:forEach items="${buys}" var="buys">
								<tr>
									<td align="center">${buys.mk_name}</td>
									<td align="center">${buys.buy_count}</td>
									<td align="center"><fmt:formatNumber value="${buys.buy_price}" />원</td>
									<td align="center">
									   <a href="/shop/goods_view?mk_id=${buys.mk_id}" class="btn btn-success btn-sm">상품후기 쓰기</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
