...
.resetBtn { background:darkgreen; width:300px; height:40px; font-size:15px; margin-top:50px; color:#fff; border:0; }
...
<div class="container">
	<form class="form-horizontal" method="post" action="/mealkit/findId" id="findIdForm">
		<div align="center" class="boxId">
			<label>이 름</label>
			<input type="text" class="form-control" id="userName" name="name" maxlength="16" placeholder="성함을 입력해주세요."/>
		</div>
		...
		<c:if test="${msg == false}">
			<div class="error">
				<p>이름과 전화번호를 다시 한번 확인하시기 바랍니다.</p>
			</div>
		</c:if>
		
		<button class="findBtn" id="submit">아이디 찾기</button>
	</form>
</div>
